...
export default async function BookingDetailPage({ params }: Props) {
  ...
  const serialized = {
    ...
    quoteParams: booking.quote
      ? {
          numberOfHelpers: booking.quote.numberOfHelpers,
          numberOfDropoffs: booking.quote.numberOfDropoffs,
          difficultAccess: booking.quote.difficultAccess,
  ...
  const serializedRateSettings = rateSettings
    ? {
        ...
        difficultAccessFee: rateSettings.difficultAccessFee.toNumber(),
